...
VOICE_IDS = {
    ...
    "female": os.environ.get("FISH_VOICE_FEMALE", "6745990b975d4041a23ad713bcee69f5"),  # Оксана (женский)
}

# ========== PROSODY НАСТРОЙКИ ==========
# 🔒 НЕ ИЗМЕНЯТЬ: Оптимизировано для профессионального, спокойного психолога
PROSODY_CONFIG = {
    "speed": 0.88,          # Медленнее обычного для вдумчивой речи (0.88 = -12% от нормы)
    "volume": 4,            # Комфортная громкость (диапазон: -20 до 20)
}

# ========== ЭМОЦИОНАЛЬНЫЕ МАРКЕРЫ ==========
# 🔒 НЕ ИЗМЕНЯТЬ: Базовая эмоциональная настройка для всех ответов
