...
async def chat_endpoint(req: ChatRequest, request: Request):
    ...
    try:
        ai_response = await get_ai_response(session_id, req.message, req.problem or user.get("selected_problem"), req.language or user.get("selected_language", "ru"), user_id=user_id)
        ...
        if not user.get("user_display_name"):
            ...
            if name_extracted:
                await db.users.update_one({"_id": ObjectId(user_id)}, {"$set": {"user_display_name": name_extracted}})
