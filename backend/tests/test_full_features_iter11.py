...
class TestAuthGuest:
    ...
    def test_guest_creation(self):
        ...
        assert data["user"].get("is_guest") == True, "User should be marked as guest"
...
class TestTariffs:
    ...
    def test_tariffs_list(self):
        ...
        print(f"✓ Tariffs returned: test, hour, week, month with correct prices")
...
class TestSessionNotes:
    ...
    def test_get_session_notes(self):
        ...
        print(f"✓ Session notes GET works")
    ...
    def test_delete_session_notes(self):
        ...
        data = response.json()
        assert "message" in data
        print(f"✓ Session notes DELETE works")
...
class TestPayments:
    ...
    def test_paid_tariff_returns_stripe_url(self):
        ...
        if response.status_code == 200:
            ...
            print(f"✓ Paid tariff returned Stripe URL")
        else:
